...
class CI_Upload {
	...
	public function do_upload($field = 'userfile')
	{
		...
		if ( ! $this->is_allowed_dimensions($D= [$_file['width'],$_file['height']]))
		{
	...
	public function is_allowed_filetype($ignore_mime = FALSE)
	{
		...
		if (in_array($ext, array('gif', 'jpg', 'jpeg', 'jpe', 'png'), TRUE) && @$this->file_size === FALSE)
		{
	 ...
	 * @return	bool
	 */
	public function is_allowed_dimensions($D = array())
	{
